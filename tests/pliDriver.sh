...
(export STEPLIB=${PLIHLQ}.SIBMZCMP:${LEHLQ}.SCEERUN; mvscmd --pgm=ibmzpli --sysprint=* --sysout=* --sysin=${TESTHLQ}.mvscmd.pli\(main\) --syslin=${TESTHLQ}.mvscmd.pli.obj\(main\) --sysut1=${TESTHLQ}.mvscmd.pli.sysut1 | awk '!/15655-/' | awk '!/0 Compiler/' )
